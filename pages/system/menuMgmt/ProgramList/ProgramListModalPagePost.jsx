...
export default function ProgramListModalPagePost({
    onClose,
    refresh,
    countProgramList,
    urlName,
    ...
    const [ProgramList, setProgramList] = useState(countProgramList);
    ...
    const onAdd = async (e) => {
        ...
        const newProgramList = countProgramList + 1;
