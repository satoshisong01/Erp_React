...
export default function PostMgmtModalPagePost({
    onClose,
    refresh,
    countPostMgmt,
    urlName,
    ...
    const [PostMgmt, setPostMgmt] = useState(countPostMgmt);
    ...
    const onAdd = async (e) => {
        ...
        const newPostMgmt = countPostMgmt + 1;
        setPostMgmt(newPostMgmt);

        const newData = {
            ...data,
            PostMgmt: newPostMgmt,
        };

        console.log(PostMgmt);
