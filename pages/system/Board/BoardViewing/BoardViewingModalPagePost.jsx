...
export default function BoardViewingModalPagePost({
    onClose,
    refresh,
    countBoardViewing,
    urlName,
    ...
    const [BoardViewing, setBoardViewing] = useState(countBoardViewing);
    ...
    const onAdd = async (e) => {
        ...
        const newBoardViewing = countBoardViewing + 1;
        setBoardViewing(newBoardViewing);

        const newData = {
            ...data,
            BoardViewing: newBoardViewing,
        };
