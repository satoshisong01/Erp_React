...
export default function CommentModalPagePost({
    onClose,
    refresh,
    countComment,
    urlName,
    ...
    const [Comment, setComment] = useState(countComment);
    ...
    const onAdd = async (e) => {
        ...
        const newComment = countComment + 1;
