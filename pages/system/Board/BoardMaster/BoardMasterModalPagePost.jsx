...
export default function BoardMasterModalPagePost({
    onClose,
    refresh,
    countBoardMaster,
    urlName,
    ...
    const [BoardMaster, setBoardMaster] = useState(countBoardMaster);
    ...
    const onAdd = async (e) => {
        ...
        const newBoardMaster = countBoardMaster + 1;
        setBoardMaster(newBoardMaster);

        const newData = {
            ...data,
            BoardMaster: newBoardMaster,
        };
