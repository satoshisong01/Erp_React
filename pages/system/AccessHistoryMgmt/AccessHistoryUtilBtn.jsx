...
export default function AccessHistoryUtilBtn({
    initialData,
    refresh,
    changeInt,
    selectedData,
    ...
    const [AccessHistory, setAccessHistory] = useState(1); //키 값 넘버자동 1씩추가
    ...
    const handleModalPostClick = (e) => {
        ...
        //console.log(item);
        //setModalItem(item);
        setAccessHistory(AccessHistory + 1);
    ...
    return (
        <div>
            ...
            {postModalOpen && (
                <AccessHistoryModalPagePost
                    onClose={() => {
                        setPostModalOpen(false);
                    }}
                    refresh={refresh}
                    countAccessHistory={AccessHistory}
                    urlName={urlName}
                    headers={headers}
                />
            )}
