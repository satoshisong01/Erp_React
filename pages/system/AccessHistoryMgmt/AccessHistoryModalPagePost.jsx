...
export default function AccessHistoryModalPagePost({
    onClose,
    refresh,
    countAccessHistory,
    urlName,
    ...
    const [AccessHistory, setAccessHistory] = useState(countAccessHistory);
    ...
    console.log(countAccessHistory);
    ...
    const onAdd = async (e) => {
        ...
        const newAccessHistory = countAccessHistory + 1;
        setAccessHistory(newAccessHistory);
                            ...
                            <div
                                ...
                                {urlName === "AccessHistory" && (
                                    <>
                                        ...
                                        <input
                                            type="text"
                                            name="AccessHistoryNm"
                                            value={data.AccessHistoryNm}
                                            onChange={inputChange}
                                        />
                                        분류코드 설명:
                                        <input
                                            type="text"
                                            name="AccessHistoryDc"
                                            value={data.AccessHistoryDc}
                                            onChange={inputChange}
                                        />
                                    </>
                                )}
