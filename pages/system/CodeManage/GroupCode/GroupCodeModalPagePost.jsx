...
export default function GroupCodeModalPagePost({
    ...
    const [selectClCode, setSelectClCode] = useState("");
                            ...
                            <div
                                ...
                                <>
                                    ...
                                    <select
                                        name="clCodeNm"
                                        onChange={(e) =>
                                            setSelectClCode(e.target.value)
                                        }>
                                        <option>분류코드를 정해주세요</option>
                                        {initialData.map((item, index) => (
                                            <option
                                                key={index}
                                                value={item.cmmnClCode.clCode}>
                                                {item.cmmnClCode.clCode}
                                            </option>
                                        ))}
                                    </select>
                                    그룹코드:
