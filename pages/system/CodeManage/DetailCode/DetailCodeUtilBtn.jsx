...
export default function DetailCodeUtilBtn({
    initialData,
    refresh,
    changeInt,
    selectedData,
    ...
    const [DetailCode, setDetailCode] = useState(1); //키 값 넘버자동 1씩추가
    ...
    return (
        <div>
            ...
            {postModalOpen && (
                <DetailCodeModalPagePost
                    onClose={() => {
                        setPostModalOpen(false);
                    }}
                    refresh={refresh}
                    countDetailCode={DetailCode}
                    urlName={urlName}
                    headers={headers}
