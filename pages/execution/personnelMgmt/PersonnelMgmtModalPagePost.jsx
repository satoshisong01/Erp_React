...
export default function PersonnelMgmtModalPagePost({
    onClose,
    refresh,
    countPersonnelMgmt,
    urlName,
    ...
    const [PersonnelMgmt, setPersonnelMgmt] = useState(countPersonnelMgmt);
    ...
    console.log(countPersonnelMgmt);
    ...
    const onAdd = async (e) => {
        ...
        const newPersonnelMgmt = countPersonnelMgmt + 1;
        setPersonnelMgmt(newPersonnelMgmt);

        const newData = {
            ...data,
            PersonnelMgmt: newPersonnelMgmt,
        };

        console.log(PersonnelMgmt);
                    ...
                    <div className="product-modal-inner">
                        ...
                        <form className="product-modal-body">
                            <div
                                ...
                                {urlName === "personnelMgmt" && (
                                    <>
                                        분류코드 명:
                                        <input
                                            type="text"
                                            name="PersonnelMgmtNm"
                                            value={data.PersonnelMgmtNm}
                                            onChange={inputChange}
                                        />
                                        분류코드 설명:
                                        <input
                                            type="text"
                                            name="PersonnelMgmtDc"
                                            value={data.PersonnelMgmtDc}
                                            onChange={inputChange}
                                        />
                                    </>
                                )}
