...
import PersonnelMgmtModalPagePost from "./PersonnelMgmtModalPagePost";

export default function PersonnelMgmtUtilBtn({
    initialData,
    refresh,
    changeInt,
    selectedData,
    ...
    const handleModalPostClick = (e) => {
        ...
        //console.log(item);
        //setModalItem(item);
        setPersonnelMgmt(PersonnelMgmt + 1);
    ...
    return (
        <div>
            ...
            {postModalOpen && (
                <PersonnelMgmtModalPagePost
                    onClose={() => {
                        setPostModalOpen(false);
                    }}
                    refresh={refresh}
                    countPersonnelMgmt={PersonnelMgmt}
                    urlName={urlName}
                    headers={headers}
