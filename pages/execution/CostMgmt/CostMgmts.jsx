...
import CostMgmtModalPage from "./CostMgmtModalPage";
import CostMgmtUtilBtn from "./CostMgmtUtilBtn";
import CostMgmtTableSearchBar from "./CostMgmtTableSearchBar";
                                                ...
                                                <table ref={dataTableRef} className="table table-bordered" id="dataTable">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            {["프로젝트명", "계획경비", "실행경비"].map((item, index) => (
