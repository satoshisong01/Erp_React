...
export default function CostMgmtModalPagePost({
    onClose,
    refresh,
    countCostMgmt,
    urlName,
    ...
    const [CostMgmt, setCostMgmt] = useState(countCostMgmt);
    ...
    const onAdd = async (e) => {
        ...
        const newCostMgmt = countCostMgmt + 1;
        setCostMgmt(newCostMgmt);

        const newData = {
            ...data,
            CostMgmt: newCostMgmt,
        };

        console.log(CostMgmt);
