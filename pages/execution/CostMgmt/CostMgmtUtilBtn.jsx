...
import CostMgmtModalPagePost from "./CostMgmtModalPagePost";

export default function CostMgmtUtilBtn({
    initialData,
    refresh,
    changeInt,
    selectedData,
    ...
    const [CostMgmt, setCostMgmt] = useState(1); //키 값 넘버자동 1씩추가
    ...
    return (
        <div>
            ...
            {postModalOpen && (
                <CostMgmtModalPagePost
                    onClose={() => {
                        setPostModalOpen(false);
                    }}
                    refresh={refresh}
                    countCostMgmt={CostMgmt}
                    urlName={urlName}
                    headers={headers}
