...
export default function BuyMgmtModalPagePost({
    onClose,
    refresh,
    countBuyMgmt,
    urlName,
    ...
    const [BuyMgmt, setBuyMgmt] = useState(countBuyMgmt);
    ...
    const onAdd = async (e) => {
        ...
        const newBuyMgmt = countBuyMgmt + 1;
        setBuyMgmt(newBuyMgmt);
