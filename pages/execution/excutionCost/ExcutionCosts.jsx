...
import ExcutionCostModalPage from "./ExcutionCostModalPage";
import ExcutionCostUtilBtn from "./ExcutionCostUtilBtn";
import ExcutionCostTableSearchBar from "./ExcutionCostTableSearchBar";
                                        ...
                                        <table ref={dataTableRef} className="table table-bordered" id="dataTable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    {["연도", "프로젝트명", "매출부서", "담당자", "시작일", "종료일", "비고", "수주상태"].map((item, index) => (
