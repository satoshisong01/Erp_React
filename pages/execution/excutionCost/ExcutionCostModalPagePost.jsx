...
export default function ExcutionCostModalPagePost({
    onClose,
    refresh,
    countExcutionCost,
    urlName,
    ...
    const [ExcutionCost, setExcutionCost] = useState(countExcutionCost);
    ...
    const onAdd = async (e) => {
        ...
        const newExcutionCost = countExcutionCost + 1;
        setExcutionCost(newExcutionCost);

        const newData = {
            ...data,
            ExcutionCost: newExcutionCost,
        };

        console.log(ExcutionCost);
