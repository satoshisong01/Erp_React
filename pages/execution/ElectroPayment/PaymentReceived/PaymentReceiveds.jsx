...
import PaymentReceivedModalPage from "./PaymentReceivedModalPage";
import PaymentReceivedUtilBtn from "./PaymentReceivedUtilBtn";
import PaymentReceivedTableSearchBar from "./PaymentReceivedTableSearchBar";
//import UserManagementInfo from "../../../sysadmin/UserManagementInfo";

const PaymentReceiveds = () => {
    ...
    const urlName = "PaymentReceiveds";
    ...
    return (
        <>
            <div className="divBodySet"></div>
            <div id="content">
                <div className="SearchDiv">
                    <PaymentReceivedTableSearchBar
                                                ...
                                                <table ref={dataTableRef} className="table table-bordered" id="dataTable">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            {["프로젝트명", "발신자", "발신일", "수신자", "수신일", "결재상태"].map((item, index) => (
                                                    ...
                                                    <tbody>
                                                        {searchedData.map((item, index) => (
                                                            <tr key={index}>
                                                                ...
                                                                {["orgId", "orgNm", "orgNm", "orgNm", "orgNm", "orgNm"].map((key) => (
                                                                    <td
...
export default PaymentReceiveds;
