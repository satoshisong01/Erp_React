...
export default function PaymentReceivedModalPagePost({
    onClose,
    refresh,
    countPaymentReceived,
    urlName,
    headers,
    initialData,
}) {
    ...
    console.log(countPaymentReceived);
    ...
    const onAdd = async (e) => {
        ...
        const newPaymentReceived = countPaymentReceived + 1;
        setPaymentReceived(newPaymentReceived);
                    ...
                    <div className="product-modal-inner">
                        ...
                        <form className="product-modal-body">
                            <div
                                ...
                                {urlName === "PaymentReceived" && (
                                    <>
                                        분류코드 명:
                                        <input
                                            type="text"
                                            name="PaymentReceivedNm"
                                            value={data.PaymentReceivedNm}
                                            onChange={inputChange}
                                        />
                                        분류코드 설명:
                                        <input
                                            type="text"
                                            name="PaymentReceivedDc"
                                            value={data.PaymentReceivedDc}
                                            onChange={inputChange}
                                        />
                                    </>
                                )}
