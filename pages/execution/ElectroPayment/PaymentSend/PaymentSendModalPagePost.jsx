...
export default function PaymentSendModalPagePost({
    onClose,
    refresh,
    countPaymentSend,
    urlName,
    ...
    const [PaymentSend, setPaymentSend] = useState(countPaymentSend);
    ...
    const onAdd = async (e) => {
        ...
        const newPaymentSend = countPaymentSend + 1;
        setPaymentSend(newPaymentSend);

        const newData = {
            ...data,
            PaymentSend: newPaymentSend,
        };
