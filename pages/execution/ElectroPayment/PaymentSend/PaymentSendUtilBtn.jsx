...
import PaymentSendModalPagePost from "./PaymentSendModalPagePost";

export default function PaymentSendUtilBtn({
    initialData,
    refresh,
    changeInt,
    selectedData,
    ...
    const [PaymentSend, setPaymentSend] = useState(1); //키 값 넘버자동 1씩추가
    ...
    return (
        <div>
            ...
            {postModalOpen && (
                <PaymentSendModalPagePost
                    onClose={() => {
                        setPostModalOpen(false);
                    }}
                    refresh={refresh}
                    countPaymentSend={PaymentSend}
                    urlName={urlName}
                    headers={headers}
