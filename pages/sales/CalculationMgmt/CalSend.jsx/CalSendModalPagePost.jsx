...
export default function CalSendModalPagePost({
    onClose,
    refresh,
    countCalSend,
    urlName,
    ...
    const [CalSend, setCalSend] = useState(countCalSend);
    ...
    const onAdd = async (e) => {
        ...
        const newCalSend = countCalSend + 1;
        setCalSend(newCalSend);
