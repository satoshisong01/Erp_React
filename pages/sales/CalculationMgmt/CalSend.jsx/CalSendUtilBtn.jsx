...
import CalSendModalPagePost from "./CalSendModalPagePost";

export default function CalSendUtilBtn({
    initialData,
    refresh,
    changeInt,
    selectedData,
    ...
    const [CalSend, setCalSend] = useState(1); //키 값 넘버자동 1씩추가
    ...
    return (
        <div>
            ...
            {postModalOpen && (
                <CalSendModalPagePost
                    onClose={() => {
                        setPostModalOpen(false);
                    }}
                    refresh={refresh}
                    countCalSend={CalSend}
                    urlName={urlName}
                    headers={headers}
