...
import CalReceiveModalPagePost from "./CalReceiveModalPagePost";

export default function CalReceiveUtilBtn({
    initialData,
    refresh,
    changeInt,
    selectedData,
    ...
    const [CalReceive, setCalReceive] = useState(1); //키 값 넘버자동 1씩추가
    ...
    return (
        <div>
            ...
            {postModalOpen && (
                <CalReceiveModalPagePost
                    onClose={() => {
                        setPostModalOpen(false);
                    }}
                    refresh={refresh}
                    countCalReceive={CalReceive}
                    urlName={urlName}
                    headers={headers}
