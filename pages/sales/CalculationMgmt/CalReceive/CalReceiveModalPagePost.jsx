...
export default function CalReceiveModalPagePost({
    onClose,
    refresh,
    countCalReceive,
    urlName,
    ...
    const [CalReceive, setCalReceive] = useState(countCalReceive);
    ...
    const onAdd = async (e) => {
        ...
        const newCalReceive = countCalReceive + 1;
        setCalReceive(newCalReceive);

        const newData = {
            ...data,
            CalReceive: newCalReceive,
        };

        console.log(CalReceive);
