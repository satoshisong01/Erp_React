...
export default function SalesCostModalPagePost({
    onClose,
    refresh,
    countSalesCost,
    urlName,
    ...
    const [SalesCost, setSalesCost] = useState(countSalesCost);
    ...
    const onAdd = async (e) => {
        ...
        const newSalesCost = countSalesCost + 1;
        setSalesCost(newSalesCost);
