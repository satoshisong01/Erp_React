...
import EstimateMgmtModalPagePost from "./EstimateMgmtModalPagePost";

export default function EstimateMgmtUtilBtn({
    initialData,
    refresh,
    changeInt,
    selectedData,
    ...
    const [EstimateMgmt, setEstimateMgmt] = useState(1); //키 값 넘버자동 1씩추가
    ...
    const handleModalPostClick = (e) => {
        ...
        //console.log(item);
        //setModalItem(item);
        setEstimateMgmt(EstimateMgmt + 1);
    ...
    return (
        <div>
            ...
            {postModalOpen && (
                <EstimateMgmtModalPagePost
                    onClose={() => {
                        setPostModalOpen(false);
                    }}
                    refresh={refresh}
                    countEstimateMgmt={EstimateMgmt}
                    urlName={urlName}
                    headers={headers}
