...
export default function EstimateMgmtModalPagePost({
    onClose,
    refresh,
    countEstimateMgmt,
    urlName,
    ...
    const [EstimateMgmt, setEstimateMgmt] = useState(countEstimateMgmt);
    ...
    const onAdd = async (e) => {
        ...
        const newEstimateMgmt = countEstimateMgmt + 1;
        setEstimateMgmt(newEstimateMgmt);

        const newData = {
            ...data,
            EstimateMgmt: newEstimateMgmt,
        };

        console.log(EstimateMgmt);
                    ...
                    <div className="product-modal-inner">
                        ...
                        <form className="product-modal-body">
                            <div
                                ...
                                {urlName === "EstimateMgmt" && (
                                    <>
                                        분류코드 명:
                                        <input
                                            type="text"
                                            name="EstimateMgmtNm"
                                            value={data.EstimateMgmtNm}
