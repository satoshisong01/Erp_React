...
export default function BusinessModalPagePost({
    onClose,
    refresh,
    countBusiness,
    urlName,
    ...
    const [Business, setBusiness] = useState(countBusiness);
    ...
    const onAdd = async (e) => {
        ...
        const newBusiness = countBusiness + 1;
