...
import ClientCompanyModalPagePost from "./ClientCompanyModalPagePost";

export default function ClientCompanyUtilBtn({
    initialData,
    refresh,
    changeInt,
    selectedData,
    ...
    const handleModalPostClick = (e) => {
        ...
        //console.log(item);
        //setModalItem(item);
        setClientCompany(ClientCompany + 1);
    ...
    return (
        <div>
            ...
            {postModalOpen && (
                <ClientCompanyModalPagePost
                    onClose={() => {
                        setPostModalOpen(false);
                    }}
                    refresh={refresh}
                    countClientCompany={ClientCompany}
                    urlName={urlName}
                    headers={headers}
