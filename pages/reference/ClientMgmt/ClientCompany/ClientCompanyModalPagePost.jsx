...
export default function ClientCompanyModalPagePost({
    onClose,
    refresh,
    countClientCompany,
    urlName,
    ...
    const [ClientCompany, setClientCompany] = useState(countClientCompany);
    ...
    console.log(countClientCompany);
    ...
    const onAdd = async (e) => {
        ...
        const newClientCompany = countClientCompany + 1;
                            ...
                            <div
                                ...
                                {urlName === "ClientCompany" && (
                                    <>
                                        ...
                                        <input
                                            type="text"
                                            name="ClientCompanyNm"
                                            value={data.ClientCompanyNm}
                                            onChange={inputChange}
                                        />
                                        분류코드 설명:
                                        <input
                                            type="text"
                                            name="ClientCompanyDc"
                                            value={data.ClientCompanyDc}
                                            onChange={inputChange}
                                        />
                                    </>
                                )}
