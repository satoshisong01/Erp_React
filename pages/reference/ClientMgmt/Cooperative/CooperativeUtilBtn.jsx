...
import CooperativeModalPagePost from "./CooperativeModalPagePost";

export default function CooperativeUtilBtn({
    initialData,
    refresh,
    changeInt,
    selectedData,
    ...
    const [Cooperative, setCooperative] = useState(1); //키 값 넘버자동 1씩추가
    ...
    return (
        <div>
            ...
            {postModalOpen && (
                <CooperativeModalPagePost
                    onClose={() => {
                        setPostModalOpen(false);
                    }}
                    refresh={refresh}
                    countCooperative={Cooperative}
                    urlName={urlName}
                    headers={headers}
