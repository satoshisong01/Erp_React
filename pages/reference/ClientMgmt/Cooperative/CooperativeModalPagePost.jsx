...
export default function CooperativeModalPagePost({
    onClose,
    refresh,
    countCooperative,
    urlName,
    ...
    const [Cooperative, setCooperative] = useState(countCooperative);
    ...
    const onAdd = async (e) => {
        ...
        const newCooperative = countCooperative + 1;
