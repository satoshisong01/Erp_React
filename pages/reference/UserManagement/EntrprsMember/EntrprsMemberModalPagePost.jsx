...
export default function EntrprsMemberModalPagePost({
    initialData,
    onClose,
    refresh,
    countEntrprsMember,
    ...
    const [EntrprsMember, setEntrprsMember] = useState(countEntrprsMember);
    ...
    console.log(countEntrprsMember);
    ...
    const onAdd = async (e) => {
        ...
        const newEntrprsMember = countEntrprsMember + 1;
        setEntrprsMember(newEntrprsMember);

        const newData = {
            ...data,
            EntrprsMember: newEntrprsMember,
        };

        console.log(EntrprsMember);
                            ...
                            <div
                                ...
                                {urlName === "generalMember" && (
                                    <>
                                        ...
                                        <input
                                            type="text"
                                            name="EntrprsMemberNm"
                                            value={data.EntrprsMemberNm}
                                            onChange={inputChange}
                                        />
                                        분류코드 설명:
                                        <input
                                            type="text"
                                            name="EntrprsMemberDc"
                                            value={data.EntrprsMemberDc}
                                            onChange={inputChange}
                                        />
                                    </>
                                )}
