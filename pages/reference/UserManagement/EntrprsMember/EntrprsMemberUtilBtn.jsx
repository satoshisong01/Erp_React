...
import EntrprsMemberModalPagePost from "./EntrprsMemberModalPagePost";

export default function EntrprsMemberUtilBtn({
    initialData,
    refresh,
    changeInt,
    selectedData,
    ...
    const handleModalPostClick = (e) => {
        ...
        //console.log(item);
        //setModalItem(item);
        setEntrprsMember(EntrprsMember + 1);
    ...
    return (
        <div>
            ...
            {postModalOpen && (
                <EntrprsMemberModalPagePost
                    onClose={() => {
                        setPostModalOpen(false);
                    }}
                    refresh={refresh}
                    countEntrprsMember={EntrprsMember}
                    urlName={urlName}
                    headers={headers}
