...
import AuthorGroupModalPagePost from "./AuthorGroupModalPagePost";

export default function AuthorGroupUtilBtn({
    initialData,
    refresh,
    changeInt,
    selectedData,
    ...
    const [AuthorGroup, setAuthorGroup] = useState(1); //키 값 넘버자동 1씩추가
    ...
    return (
        <div>
            ...
            {postModalOpen && (
                <AuthorGroupModalPagePost
                    onClose={() => {
                        setPostModalOpen(false);
                    }}
                    refresh={refresh}
                    countAuthorGroup={AuthorGroup}
                    urlName={urlName}
                    headers={headers}
