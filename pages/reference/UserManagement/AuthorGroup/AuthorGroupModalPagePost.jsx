...
export default function AuthorGroupModalPagePost({
    initialData,
    onClose,
    refresh,
    countAuthorGroup,
    ...
    const onAdd = async (e) => {
        ...
        const newAuthorGroup = countAuthorGroup + 1;
        setAuthorGroup(newAuthorGroup);
