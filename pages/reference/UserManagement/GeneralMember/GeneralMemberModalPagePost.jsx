...
export default function GeneralMemberModalPagePost({
    initialData,
    onClose,
    refresh,
    countGeneralMember,
    ...
    const [GeneralMember, setGeneralMember] = useState(countGeneralMember);
    ...
    console.log(countGeneralMember);
    ...
    const onAdd = async (e) => {
        ...
        const newGeneralMember = countGeneralMember + 1;
        setGeneralMember(newGeneralMember);

        const newData = {
            ...data,
            GeneralMember: newGeneralMember,
        };
                            ...
                            <div
                                ...
                                {urlName === "generalMember" && (
                                    <>
                                        ...
                                        <input
                                            type="text"
                                            name="GeneralMemberNm"
                                            value={data.GeneralMemberNm}
                                            onChange={inputChange}
                                        />
                                        분류코드 설명:
                                        <input
                                            type="text"
                                            name="GeneralMemberDc"
                                            value={data.GeneralMemberDc}
                                            onChange={inputChange}
                                        />
                                    </>
                                )}
