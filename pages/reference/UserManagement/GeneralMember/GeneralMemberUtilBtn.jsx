...
import GeneralMemberModalPagePost from "./GeneralMemberModalPagePost";

export default function GeneralMemberUtilBtn({
    initialData,
    refresh,
    changeInt,
    selectedData,
    ...
    const [GeneralMember, setGeneralMember] = useState(1); //키 값 넘버자동 1씩추가
    ...
    const handleModalPostClick = (e) => {
        ...
        //console.log(item);
        //setModalItem(item);
        setGeneralMember(GeneralMember + 1);
    ...
    return (
        <div>
            ...
            {postModalOpen && (
                <GeneralMemberModalPagePost
                    onClose={() => {
                        setPostModalOpen(false);
                    }}
                    refresh={refresh}
                    countGeneralMember={GeneralMember}
                    urlName={urlName}
                    headers={headers}
