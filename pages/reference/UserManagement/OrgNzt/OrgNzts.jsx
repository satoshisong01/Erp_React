...
import OrgNztModalPage from "./OrgNztModalPage";
import OrgNztUtilBtn from "./OrgNztUtilBtn";
import OrgNztTableSearchBar from "./OrgNztTableSearchBar";
                                        ...
                                        <table ref={dataTableRef} className="table table-bordered" id="dataTable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    {["ID", "조직이름", "조직코드", "설명", "작성일", "작성자", "수정일", "수정자"].map((item, index) => (
