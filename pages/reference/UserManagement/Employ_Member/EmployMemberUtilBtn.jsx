...
import EmployMemberModalPagePost from "./EmployMemberModalPagePost";

export default function EmployMemberUtilBtn({
    initialData,
    refresh,
    changeInt,
    selectedData,
    ...
    const [EmployMember, setEmployMember] = useState(1); //키 값 넘버자동 1씩추가
    ...
    const handleModalPostClick = (e) => {
        ...
        //console.log(item);
        //setModalItem(item);
        setEmployMember(EmployMember + 1);
    ...
    return (
        <div>
            ...
            {postModalOpen && (
                <EmployMemberModalPagePost
                    onClose={() => {
                        setPostModalOpen(false);
                    }}
                    refresh={refresh}
                    countEmployMember={EmployMember}
                    urlName={urlName}
                    headers={headers}
