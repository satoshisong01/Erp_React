...
export default function CompanyMgmtModalPagePost({
    onClose,
    refresh,
    countCompanyMgmt,
    urlName,
    ...
    const [CompanyMgmt, setCompanyMgmt] = useState(countCompanyMgmt);
    ...
    const onAdd = async (e) => {
        ...
        const newCompanyMgmt = countCompanyMgmt + 1;
        setCompanyMgmt(newCompanyMgmt);

        const newData = {
            ...data,
            CompanyMgmt: newCompanyMgmt,
        };

        console.log(CompanyMgmt);
