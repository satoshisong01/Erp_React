...
import CompanyMgmtModalPagePost from "./CompanyMgmtModalPagePost";

export default function CompanyMgmtUtilBtn({
    initialData,
    refresh,
    changeInt,
    selectedData,
    ...
    const [CompanyMgmt, setCompanyMgmt] = useState(1); //키 값 넘버자동 1씩추가
    ...
    return (
        <div>
            ...
            {postModalOpen && (
                <CompanyMgmtModalPagePost
                    onClose={() => {
                        setPostModalOpen(false);
                    }}
                    refresh={refresh}
                    countCompanyMgmt={CompanyMgmt}
                    urlName={urlName}
                    headers={headers}
