...
import CompanyMgmtModalPage from "./CompanyMgmtModalPage";
import CompanyMgmtUtilBtn from "./CompanyMgmtUtilBtn";
import CompanyMgmtTableSearchBar from "./CompanyMgmtTableSearchBar";
                                            ...
                                            <tbody>
                                                {searchedData.map((item, index) => (
                                                    <tr key={index}>
                                                        ...
                                                        {["orgId", "orgNm", "createDate"].map((key) => (
                                                            <td
