...
export default function UnitPricePersonModalPagePost({
    onClose,
    refresh,
    countUnitPricePerson,
    urlName,
    headers,
    initialData,
}) {
    const dataTableRef = useRef(null); //dataTable 테이블 명시
    const [UnitPricePerson, setUnitPricePerson] =
        useState(countUnitPricePerson);
    ...
    console.log(countUnitPricePerson);
    ...
    const onAdd = async (e) => {
        ...
        const newUnitPricePerson = countUnitPricePerson + 1;
        setUnitPricePerson(newUnitPricePerson);

        const newData = {
            ...data,
            UnitPricePerson: newUnitPricePerson,
        };

        console.log(UnitPricePerson);
                    ...
                    <div className="product-modal-inner">
                        ...
                        <form className="product-modal-body">
                            <div
                                ...
                                {urlName === "UnitPricePerson" && (
                                    <>
                                        분류코드 명:
                                        <input
                                            type="text"
                                            name="UnitPricePersonNm"
                                            value={data.UnitPricePersonNm}
                                            onChange={inputChange}
                                        />
                                        분류코드 설명:
                                        <input
                                            type="text"
                                            name="UnitPricePersonDc"
                                            value={data.UnitPricePersonDc}
                                            onChange={inputChange}
                                        />
                                    </>
                                )}
