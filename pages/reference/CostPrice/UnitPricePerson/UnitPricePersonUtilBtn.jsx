...
import UnitPricePersonModalPagePost from "./UnitPricePersonModalPagePost";

export default function UnitPricePersonUtilBtn({
    initialData,
    refresh,
    changeInt,
    selectedData,
    ...
    const [UnitPricePerson, setUnitPricePerson] = useState(1); //키 값 넘버자동 1씩추가
    ...
    const handleModalPostClick = (e) => {
        ...
        //console.log(item);
        //setModalItem(item);
        setUnitPricePerson(UnitPricePerson + 1);
    ...
    return (
        <div>
            ...
            {postModalOpen && (
                <UnitPricePersonModalPagePost
                    onClose={() => {
                        setPostModalOpen(false);
                    }}
                    refresh={refresh}
                    countUnitPricePerson={UnitPricePerson}
                    urlName={urlName}
                    headers={headers}
