...
import UnitPriceCostModalPagePost from "./UnitPriceCostModalPagePost";

export default function UnitPriceCostUtilBtn({
    initialData,
    refresh,
    changeInt,
    selectedData,
    ...
    const [UnitPriceCost, setUnitPriceCost] = useState(1); //키 값 넘버자동 1씩추가
    ...
    const handleModalPostClick = (e) => {
        ...
        //console.log(item);
        //setModalItem(item);
        setUnitPriceCost(UnitPriceCost + 1);
    ...
    return (
        <div>
            ...
            {postModalOpen && (
                <UnitPriceCostModalPagePost
                    onClose={() => {
                        setPostModalOpen(false);
                    }}
                    refresh={refresh}
                    countUnitPriceCost={UnitPriceCost}
                    urlName={urlName}
                    headers={headers}
