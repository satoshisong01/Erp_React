...
import PreCostModalPage from "./PreCostModalPage";
import PreCostUtilBtn from "./PreCostUtilBtn";
import PreCostTableSearchBar from "./PreCostTableSearchBar";
                                        ...
                                        <table ref={dataTableRef} className="table table-bordered" id="dataTable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    {["분류", "간접원가", "판 매 비", "사내본사비", "일반관리비", "영업외수지"].map((item, index) => (
                                            ...
                                            <tbody>
                                                {searchedData.map((item, index) => (
                                                    <tr key={index}>
                                                        ...
                                                        {["orgId", "orgNm", "createDate", "createIdBy", "orgId", "orgNm"].map((key) => (
                                                            <td
