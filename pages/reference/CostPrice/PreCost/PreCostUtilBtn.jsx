...
import PreCostModalPagePost from "./PreCostModalPagePost";

export default function PreCostUtilBtn({
    initialData,
    refresh,
    changeInt,
    selectedData,
    ...
    const [PreCost, setPreCost] = useState(1); //키 값 넘버자동 1씩추가
    ...
    return (
        <div>
            ...
            {postModalOpen && (
                <PreCostModalPagePost
                    onClose={() => {
                        setPostModalOpen(false);
                    }}
                    refresh={refresh}
                    countPreCost={PreCost}
                    urlName={urlName}
                    headers={headers}
