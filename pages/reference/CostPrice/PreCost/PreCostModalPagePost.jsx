...
export default function PreCostModalPagePost({
    onClose,
    refresh,
    countPreCost,
    urlName,
    ...
    const [PreCost, setPreCost] = useState(countPreCost);
    ...
    const onAdd = async (e) => {
        ...
        const newPreCost = countPreCost + 1;
        setPreCost(newPreCost);
