...
import PersonnelExpenseModalPagePost from "./PersonnelExpenseModalPagePost";

export default function PersonnelExpenseUtilBtn({
    initialData,
    refresh,
    changeInt,
    selectedData,
    ...
    const [PersonnelExpense, setPersonnelExpense] = useState(1); //키 값 넘버자동 1씩추가
    ...
    const handleModalPostClick = (e) => {
        ...
        //console.log(item);
        //setModalItem(item);
        setPersonnelExpense(PersonnelExpense + 1);
    ...
    return (
        <div>
            ...
            {postModalOpen && (
                <PersonnelExpenseModalPagePost
                    onClose={() => {
                        setPostModalOpen(false);
                    }}
                    refresh={refresh}
                    countPersonnelExpense={PersonnelExpense}
                    urlName={urlName}
                    headers={headers}
