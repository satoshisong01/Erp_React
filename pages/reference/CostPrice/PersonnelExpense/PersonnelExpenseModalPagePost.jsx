...
export default function PersonnelExpenseModalPagePost({
    onClose,
    refresh,
    countPersonnelExpense,
    urlName,
    headers,
    initialData,
}) {
    const dataTableRef = useRef(null); //dataTable 테이블 명시
    const [PersonnelExpense, setPersonnelExpense] = useState(
        countPersonnelExpense
    );
    ...
    console.log(countPersonnelExpense);
    ...
    const onAdd = async (e) => {
        ...
        const newPersonnelExpense = countPersonnelExpense + 1;
        setPersonnelExpense(newPersonnelExpense);

        const newData = {
            ...data,
            PersonnelExpense: newPersonnelExpense,
        };

        console.log(PersonnelExpense);
                            ...
                            <div
                                ...
                                {urlName === "PersonnelExpense" && (
                                    <>
                                        ...
                                        <input
                                            type="text"
                                            name="PersonnelExpenseNm"
                                            value={data.PersonnelExpenseNm}
                                            onChange={inputChange}
                                        />
                                        분류코드 설명:
                                        <input
                                            type="text"
                                            name="PersonnelExpenseDc"
                                            value={data.PersonnelExpenseDc}
                                            onChange={inputChange}
                                        />
                                    </>
                                )}
