...
export default function ProductPriceUtilBtn({
    initialData,
    refresh,
    changeInt,
    selectedData,
    ...
    const [ProductPrice, setProductPrice] = useState(1); //키 값 넘버자동 1씩추가
    ...
    return (
        <div>
            ...
            {postModalOpen && (
                <ProductPriceModalPagePost
                    onClose={() => {
                        setPostModalOpen(false);
                    }}
                    refresh={refresh}
                    countProductPrice={ProductPrice}
                    urlName={urlName}
                    headers={headers}
