...
export default function ProductPriceModalPagePost({
    onClose,
    refresh,
    countProductPrice,
    urlName,
    ...
    const [ProductPrice, setProductPrice] = useState(countProductPrice);
    ...
    const onAdd = async (e) => {
        ...
        const newProductPrice = countProductPrice + 1;
