...
import ProductPriceModalPage from "./ProductPriceModalPage";
import ProductPriceUtilBtn from "./ProductPriceUtilBtn";
import ProductPriceTableSearchBar from "./ProductPriceTableSearchBar";
...
const ProductPrices = () => {
    ...
    return (
        <>
            <div id="content">
                <div className="row">
                    <BigBreadcrumbs items={["품목 관리", "품목 단가 관리"]} icon="fa fa-fw fa-table" className="col-xs-12 col-sm-7 col-md-7 col-lg-4" />
                </div>
                <div className="SearchDiv">
                    <Search searchTitle="사용자 검색" />
                    <ProductPriceTableSearchBar
                ...
                <WidgetGrid>
                    <div className="row">
                        <article className="col-sm-12">
                            <JarvisWidget id="wid-id-0" editbutton={true} color="blueDark">
                                <header>
                                                    ...
                                                    <table
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                {["ID", "조직이름", "조직코드", "설명", "작성일", "작성자", "수정일", "수정자"].map(
                                                                    (item, index) => (
