...
export default function ProductInfoModalPagePost({
    onClose,
    refresh,
    countProductInfo,
    urlName,
    ...
    const [ProductInfo, setProductInfo] = useState(countProductInfo);
    ...
    const onAdd = async (e) => {
        ...
        const newProductInfo = countProductInfo + 1;
