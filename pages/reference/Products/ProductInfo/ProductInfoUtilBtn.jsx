...
import ProductInfoModalPagePost from "./ProductInfoModalPagePost";

export default function ProductInfoUtilBtn({
    initialData,
    refresh,
    changeInt,
    selectedData,
    ...
    const [ProductInfo, setProductInfo] = useState(1); //키 값 넘버자동 1씩추가
    ...
    return (
        <div>
            ...
            {postModalOpen && (
                <ProductInfoModalPagePost
                    onClose={() => {
                        setPostModalOpen(false);
                    }}
                    refresh={refresh}
                    countProductInfo={ProductInfo}
                    urlName={urlName}
                    headers={headers}
