...
import ProductGroupModalPage from "./ProductGroupModalPage";
import ProductGroupUtilBtn from "./ProductGroupUtilBtn";
import ProductGroupTableSearchBar from "./ProductGroupTableSearchBar";
                                        ...
                                        <table ref={dataTableRef} className="table table-bordered" id="dataTable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    {["품목그룹명", "품목구분코드", "작성일", "작성자"].map((item, index) => (
                                            ...
                                            <tbody>
                                                {searchedData.map((item, index) => (
                                                    <tr key={index}>
                                                        ...
                                                        {["orgId", "orgNm", "createDate", "createIdBy"].map((key) => (
                                                            <td
