...
export default function ProductGroupModalPagePost({
    onClose,
    refresh,
    countProductGroup,
    urlName,
    ...
    const [ProductGroup, setProductGroup] = useState(countProductGroup);
    ...
    const onAdd = async (e) => {
        ...
        const newProductGroup = countProductGroup + 1;
