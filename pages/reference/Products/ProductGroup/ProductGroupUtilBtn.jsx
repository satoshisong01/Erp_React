...
import ProductGroupModalPagePost from "./ProductGroupModalPagePost";

export default function ProductGroupUtilBtn({
    initialData,
    refresh,
    changeInt,
    selectedData,
    ...
    const [ProductGroup, setProductGroup] = useState(1); //키 값 넘버자동 1씩추가
    ...
    const handleModalPostClick = (e) => {
        ...
        //console.log(item);
        //setModalItem(item);
        setProductGroup(ProductGroup + 1);
    ...
    return (
        <div>
            ...
            {postModalOpen && (
                <ProductGroupModalPagePost
                    onClose={() => {
                        setPostModalOpen(false);
                    }}
                    refresh={refresh}
                    countProductGroup={ProductGroup}
                    urlName={urlName}
                    headers={headers}
