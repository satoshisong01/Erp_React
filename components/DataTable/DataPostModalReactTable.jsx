...
import $ from "jquery";
import "../../components/modal/ModalReactTable.css";
...
export default function DataPostModalReactTable({ refresh, postData, columns, onClose, errorOn, fetchAllData, handleSendLoading, selectList }) {
