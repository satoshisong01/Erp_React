...
/* 데이터 테이블 검색 */
export default function SearchListCompany({ conditionList, onSearch }) {
                ...
                <div className="flex-container" style={{ margin: "10px" }}>
                    {fieldList.map((param) => (
                        <div key={param.colName} className="flex-group mg-l-15">
                            ...
                            <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }} className="flex-input">
                                {renderField(param)}
                            </div>
                        </div>
                    ))}
